...
const tokenWith = (name, content, isSuffix = false) => txt(`(?<${name}>${content})`, isSuffix);
const token = (name, moreChar = "", isSuffix = false) => tokenWith(name, `[a-zA-Z0-9_\\-${moreChar}]+`, isSuffix);
const keyword = (name, value, isSuffix = false) => tokenWith(name, value, isSuffix);
